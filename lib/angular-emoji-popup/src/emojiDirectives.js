            ...
            function(e)
            {
                ...
                if (e.keyCode == 13)
                {
                    ...
                    if (submit)
                    {
                        $timeout.cancel(updatePromise);
                        updateValue();
                        // todo: I commented .replyToUser and cancelEvent as replyToUser is not implemented (need to check original code) and cancelEvent prevented to add a br - Ruben
                        //$scope.emojiMessage.replyToUser();
                        // $(element).trigger('message_send'); // this was already commented on original code - Ruben
                        resetTyping();
