 ...
 function buildSliding4Doors() {
	...
	$('.qitem').each(function () {
		...
		$(this).children('div').slice(1).css('background-image','url('+ img + ')');
	...
	function () {
		...
		//go to the url
		// Commented since I dont want to to go anywere and the page is going up. 01/2012 - RC
